      ...
      <main className="max-w-4xl mx-auto px-4 py-8 pb-32">
        <div className="space-y-8">
          ...
          <Card className="border-0 shadow-lg pb-8">
            ...
            <CardContent className="p-0">
              <RentInput
                onSubmit={data => handlePanelComplete('rent', true, 20)}
                onExpGain={handleExpGain}
              />
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg pb-8">
            ...
            <CardContent className="p-0">
              <CommunicationInput
                onSubmit={data =>
                  handlePanelComplete('communication', true, 15)
                }
                onExpGain={handleExpGain}
              />
            </CardContent>
          ...
          <Card className="border-0 shadow-lg pb-8">
            ...
            <CardContent className="p-0">
              <FoodInput
                onSubmit={data => handlePanelComplete('food', true, 10)}
                onExpGain={handleExpGain}
              />
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg pb-8">
            ...
            <CardContent className="p-0">
              <ActivityInput
                onSubmit={data => handlePanelComplete('activity', true, 15)}
                onExpGain={handleExpGain}
              />
            </CardContent>
          </Card>
