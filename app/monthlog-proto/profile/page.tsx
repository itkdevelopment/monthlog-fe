...
export default function ProfilePage() {
  const [userProfile, setUserProfile] = useState<UserProfile>({
    id: 'user_001',
    username: '애나',
    avatar: 'https://v0-b5-six.vercel.app/images/profile-avatar.png',
    level: 15,
    currentExp: 2340,
    nextLevelExp: 3000,
    totalExp: 12340,
              ...
              <div className="flex items-center space-x-2">
                <Avatar className="h-12 w-12">
                  <AvatarImage
                    src={
                      userProfile.avatar ||
                      'https://v0-b5-six.vercel.app/images/profile-avatar.png'
                    }
                  />
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="text-xs text-gray-500">
                                {journey.period} • 재방문 의향:{' '}
                                {journey.revisitScore}/10
                              </div>
