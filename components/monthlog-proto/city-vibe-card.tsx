...
export default function CityVibeCard({ onExpGain }: CityVibeCardProps) {
  ...
  const [photos, setPhotos] = useState<CityVibePhoto[]>(
    [
      {
        id: '1',
        imageUrl: 'https://v0-b5-six.vercel.app/images/jeju-coast-1.avif',
        author: '제주러버',
      ...
      {
        id: '2',
        imageUrl: 'https://v0-b5-six.vercel.app/images/jeju-hills-2.avif',
        author: '워케이션왕',
        authorAvatar: '/placeholder.svg?height=40&width=40',
        recommendations: 32,
        isRecommended: false,
      ...
      {
        id: '3',
        imageUrl: 'https://v0-b5-six.vercel.app/images/jeju-beach-3.avif',
        author: '힐링마스터',
        authorAvatar: '/placeholder.svg?height=40&width=40',
        recommendations: 67,
        isRecommended: true,
      ...
      {
        id: '4',
        imageUrl: 'https://v0-b5-six.vercel.app/images/jeju-mountain-4.avif',
        author: '제주탐험가',
        authorAvatar: '/placeholder.svg?height=40&width=40',
        recommendations: 28,
        isRecommended: false,
      ...
      {
        id: '5',
        imageUrl: 'https://v0-b5-six.vercel.app/images/jeju-coastline-5.avif',
        author: '바다사랑',
        authorAvatar: '/placeholder.svg?height=40&width=40',
        recommendations: 41,
        isRecommended: false,
      ...
      {
        id: '6',
        imageUrl: 'https://v0-b5-six.vercel.app/images/jeju-sunset-6.avif',
        author: '로컬푸드',
        authorAvatar: '/placeholder.svg?height=40&width=40',
        recommendations: 19,
        isRecommended: false,
        ...
        prev.map(photo =>
          photo.id === photoId
            ? {
                ...photo,
                isRecommended: true,
                recommendations: photo.recommendations + 1,
              }
            : photo,
        ),
      );
  ...
  const handlePhotoClickInCard = useCallback(
                ...
                >
                  <div className="relative overflow-hidden rounded-lg">
                    <img
                      src={
                        photo.imageUrl ||
                        'https://v0-b5-six.vercel.appplaceholder.svg'
                      }
