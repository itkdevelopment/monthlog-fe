...
export function CostBudgetCard({
  ...
  const calculateBudget = () => {
    ...
    return {
      rentMedian:
        Math.round(130 * monthlyMultiplier * (people > 1 ? 1.5 : 1)) + '만원',
      transportation:
        Math.round(12 * monthlyMultiplier * peopleMultiplier) + '만원',
      totalEstimate:
        Math.round(200 * monthlyMultiplier * peopleMultiplier) + '만원',
  ...
  const getCurrentData = () => {
    if (budgetCalculator.isSimulationMode) {
      ...
      return {
        ...
        utilities: Math.round((8 + 5 + 3) * monthlyMultiplier) + '만원',
        foodCost:
          Math.round(60 * monthlyMultiplier * peopleMultiplier) + '만원',
      };
    }
    return {
                  ...
                  <div className="relative flex items-center">
                    ...
                    <div className="ml-1 group">
                      ...
                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
                        월세 제외, 식비+교통비+통신비+공과금의 최소 비용 (합산의
                        25%)
                      </div>
                    </div>
                  </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center justify-between py-2 group relative">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <AnimatedNumber
                    value={
                      getCurrentData().rentMedian + ', 발품가능, 추천숙소 3곳'
                    }
                  />
                </span>
                <button
            ...
            <div className="flex items-center justify-between py-2 group relative">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <AnimatedNumber
                    value={getCurrentData().utilities + ', 전기요금 15,000원'}
                  />
                </span>
                <button
                  onClick={() => openDetailPanel('utilities')}
            ...
            <div className="flex items-center justify-between py-2 group relative">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <AnimatedNumber
                    value={getCurrentData().transportation + ', 택시 선호'}
                  />
                </span>
                <button
                  onClick={() => openDetailPanel('transport')}
