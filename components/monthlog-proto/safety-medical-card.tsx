...
export default function SafetyMedicalCard({
  ...
  return (
    <>
      {/* 패널들 */}
      <SafetyLevelPanel
        isOpen={activePanelType === 'safetyLevel'}
        onClose={closePanel}
      />
      <MedicalLevelPanel
        isOpen={activePanelType === 'medicalLevel'}
        onClose={closePanel}
      />
      <WaterSafetyPanel
        isOpen={activePanelType === 'waterSafety'}
        onClose={closePanel}
      />
      <CrimeTypesPanel
        isOpen={activePanelType === 'crimeTypes'}
        onClose={closePanel}
      />
      <EmergencyContactsPanel
        isOpen={activePanelType === 'emergencyContacts'}
        onClose={closePanel}
      />
      <EmbassyContactsPanel
        isOpen={activePanelType === 'embassyContacts'}
        onClose={closePanel}
      />
