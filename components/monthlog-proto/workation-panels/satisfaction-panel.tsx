...
export default function SatisfactionPanel({ isOpen, onClose }: SatisfactionPanelProps) {
    ...
    <AnimatePresence>
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-gray-200 flex-shrink-0">
          <h2 className="text-2xl font-bold text-gray-900">워케이션 환경 만족도 {averageScore}/10</h2>
        ...
        <div className="flex-1 flex min-h-0">
          ...
          <div className="w-[70%] bg-white overflow-y-auto">
            <div className="px-16 py-6 space-y-8 pb-24">
              <SatisfactionInput onScoreChange={setSelectedScore} selectedScore={selectedScore} />
